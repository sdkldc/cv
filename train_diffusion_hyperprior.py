...
def main():
    parser = argparse.ArgumentParser(description='Train Diffusion Hyperprior Compression Model')
    ...
    parser.add_argument('--lambda_rate', type=float, default=1e-4, help='Rate-distortion trade-off')
    parser.add_argument('--image_size', type=int, default=256, help='Image size')
    parser.add_argument('--N', type=int, default=128, help='Number of channels N')
    parser.add_argument('--M', type=int, default=128, help='Number of channels M')
